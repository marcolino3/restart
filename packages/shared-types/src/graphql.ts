...
export type AbsenceCategoryQuota = {
  __typename?: 'AbsenceCategoryQuota';
...
export type AuthContextOutput = {
  ...
  fieldPermissions: Array<EffectiveFieldPermissionOutput>;
  isProjectMember: Scalars['Boolean']['output'];
  isSuperAdmin: Scalars['Boolean']['output'];
  orgId?: Maybe<Scalars['String']['output']>;
  orgName?: Maybe<Scalars['String']['output']>;
  orgTimezone?: Maybe<Scalars['String']['output']>;
...
export type BulkUpdateOrganizationFeatureTogglesInput = {
...
export type ChangeOrganizationPlanInput = {
  ...
  contractEndsAt?: InputMaybe<Scalars['String']['input']>;
  id: Scalars['ID']['input'];
  plan: Scalars['String']['input'];
  userLicenseLimit?: InputMaybe<Scalars['Int']['input']>;
};
...
export type CompanyVacation = {
  ...
  createdAt: Scalars['DateTime']['output'];
  deletedAt?: Maybe<Scalars['DateTime']['output']>;
  effectiveDays: Scalars['Float']['output'];
  endDate: Scalars['String']['output'];
  holidays: Array<CompanyVacationHoliday>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
  isArchived: Scalars['Boolean']['output'];
  name: Scalars['String']['output'];
...
export type CompanyVacationHoliday = {
  __typename?: 'CompanyVacationHoliday';
...
export type CreateEmployeeAbsenceCategoryInput = {
  ...
  maxDaysAhead?: InputMaybe<Scalars['Int']['input']>;
...
export type CreateEmployeeContractInput = {
  ...
  shiftPreferences?: InputMaybe<Array<ShiftPreferenceInput>>;
  shiftWeekdays?: InputMaybe<Array<Scalars['String']['input']>>;
  startDate: Scalars['String']['input'];
  supervisorMembershipId?: InputMaybe<Scalars['ID']['input']>;
  weekdayTimeWindows?: InputMaybe<WeekdayTimeWindowsInput>;
  weekdayWorkloads?: InputMaybe<WeekdayWorkloadsInput>;
  weeklyHours?: InputMaybe<Scalars['String']['input']>;
  workloadPercent?: InputMaybe<Scalars['Float']['input']>;
  worksShifts?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type CreateEmployeeVacationInput = {
  accrualType?: InputMaybe<EmployeeVacationAccrualType>;
  employeeId: Scalars['ID']['input'];
  endDate: Scalars['String']['input'];
  name?: InputMaybe<Scalars['String']['input']>;
...
export type CreateGradeLevelInput = {
  ...
  color?: InputMaybe<Scalars['String']['input']>;
  curriculumLevelId?: InputMaybe<Scalars['ID']['input']>;
  name: Scalars['String']['input'];
  parentId?: InputMaybe<Scalars['ID']['input']>;
...
export type CreateHolidayInput = {
  ...
  repeatsYearly?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type CreateOrganizationInput = {
  activeLevels?: InputMaybe<Array<Scalars['String']['input']>>;
  billingAddressExtra?: InputMaybe<Scalars['String']['input']>;
  billingAddressSameAsLocation?: InputMaybe<Scalars['Boolean']['input']>;
  billingAmountChf?: InputMaybe<Scalars['Float']['input']>;
  billingEmail?: InputMaybe<Scalars['String']['input']>;
  billingInterval?: InputMaybe<Scalars['String']['input']>;
  bvgContactPhone?: InputMaybe<Scalars['String']['input']>;
  bvgProvider?: InputMaybe<Scalars['String']['input']>;
  careModel?: InputMaybe<Scalars['String']['input']>;
  city?: InputMaybe<Scalars['String']['input']>;
  contactEmail?: InputMaybe<Scalars['String']['input']>;
  ...
  contactSalutation?: InputMaybe<Scalars['String']['input']>;
  contactTitle?: InputMaybe<Scalars['String']['input']>;
  contractEndsAt?: InputMaybe<Scalars['String']['input']>;
  country?: InputMaybe<Scalars['String']['input']>;
  currentSchoolYear?: InputMaybe<Scalars['String']['input']>;
...
export type CreateShiftInput = {
  breaks?: InputMaybe<Array<ShiftBreakInput>>;
  color?: InputMaybe<Scalars['String']['input']>;
...
export type DailyTimeTracking = {
  __typename?: 'DailyTimeTracking';
  color?: Maybe<Scalars['String']['output']>;
  date: Scalars['String']['output'];
  entries?: Maybe<Array<DailyTimeTrackingEntry>>;
...
export type DailyTimeTrackingEntry = {
  __typename?: 'DailyTimeTrackingEntry';
...
export type DecideEmployeeAbsenceInput = {
  id: Scalars['ID']['input'];
  note?: InputMaybe<Scalars['String']['input']>;
};
...
export type EffectiveFieldPermissionOutput = {
  __typename?: 'EffectiveFieldPermissionOutput';
...
export type Employee = {
  ...
  accountLinkStatus: Scalars['String']['output'];
  createdAt: Scalars['DateTime']['output'];
  deletedAt?: Maybe<Scalars['DateTime']['output']>;
  firstName: Scalars['String']['output'];
  id: Scalars['ID']['output'];
...
export type EmployeeAbsenceCategory = {
  ...
  maxDaysAhead?: Maybe<Scalars['Int']['output']>;
  maxDaysPerRequest?: Maybe<Scalars['Int']['output']>;
  maxDaysPerYear?: Maybe<Scalars['Int']['output']>;
  organizationId: Scalars['ID']['output'];
...
export type EmployeeCompanyVacation = {
  __typename?: 'EmployeeCompanyVacation';
  companyVacationId: Scalars['ID']['output'];
  effectiveDays: Scalars['Float']['output'];
  endDate: Scalars['String']['output'];
  holidays: Array<CompanyVacationHoliday>;
...
export type EmployeeContract = {
  ...
  shiftPreferences: Array<ShiftPreference>;
  shiftWeekdays: Array<Scalars['String']['output']>;
  startDate: Scalars['String']['output'];
  ...
  worksShifts: Scalars['Boolean']['output'];
};
...
export enum EmployeeVacationAccrualType {
  Charged = 'CHARGED',
  PaidNoCharge = 'PAID_NO_CHARGE',
  Unpaid = 'UNPAID'
}

export type EmployeeVacationSegment = {
  __typename?: 'EmployeeVacationSegment';
  effectiveDays: Scalars['Float']['output'];
  employeeVacationId: Scalars['ID']['output'];
  endDate: Scalars['String']['output'];
  holidays: Array<CompanyVacationHoliday>;
  id: Scalars['ID']['output'];
  isSplit: Scalars['Boolean']['output'];
...
export type GradeLevel = {
  ...
  curriculumLevelId?: Maybe<Scalars['String']['output']>;
  deletedAt?: Maybe<Scalars['DateTime']['output']>;
  id: Scalars['ID']['output'];
  isActive: Scalars['Boolean']['output'];
  isArchived: Scalars['Boolean']['output'];
...
export type Holiday = {
  ...
  organizationId: Scalars['ID']['output'];
  paidPercentage: Scalars['Int']['output'];
  repeatsYearly: Scalars['Boolean']['output'];
  updatedAt: Scalars['DateTime']['output'];
  version: Scalars['Int']['output'];
};
...
export type LessonRecord = {
  ...
  attachments?: Maybe<Array<LessonRecordAttachment>>;
...
export type LessonRecordAttachment = {
  __typename?: 'LessonRecordAttachment';
  createdAt: Scalars['DateTime']['output'];
  deletedAt?: Maybe<Scalars['DateTime']['output']>;
  ...
  isActive: Scalars['Boolean']['output'];
  isArchived: Scalars['Boolean']['output'];
  lessonRecord?: Maybe<LessonRecord>;
  lessonRecordId: Scalars['ID']['output'];
  mimeType: Scalars['String']['output'];
  organization?: Maybe<Organization>;
  organizationId: Scalars['String']['output'];
  sizeBytes: Scalars['Int']['output'];
...
export type MonthlyTimeTrackingGroup = {
  __typename?: 'MonthlyTimeTrackingGroup';
  days: Array<DailyTimeTracking>;
...
export type Mutation = {
  ...
  approveEmployeeAbsence: EmployeeAbsence;
  ...
  bulkUpdateOrganizationFeatureToggles: Array<OrganizationFeatureToggle>;
  ...
  deleteLessonRecordsGroup: Scalars['Boolean']['output'];
  ...
  rejectEmployeeAbsence: EmployeeAbsence;
  removeCountry: Country;
  removeEmployeeOnboardingDraft: Scalars['Boolean']['output'];
  ...
  updateLessonRecordsGroup: Array<LessonRecord>;
  updateMembership: Membership;
  updateMyTheme: Scalars['Boolean']['output'];
  updateOrganization: Organization;
  updateOrganizationFeatureToggle: Array<OrganizationFeatureToggle>;
  ...
  withdrawMyEmployeeAbsenceRequest: Scalars['Boolean']['output'];
};
...
export type MutationApproveEmployeeAbsenceArgs = {
  input: DecideEmployeeAbsenceInput;
};
...
export type MutationBulkUpdateOrganizationFeatureTogglesArgs = {
...
export type MutationDeleteLessonRecordsGroupArgs = {
...
export type MutationExportOrganizationDataArgs = {
...
export type MutationReactivateOrganizationArgs = {
  id: Scalars['String']['input'];
};
...
export type MutationRejectEmployeeAbsenceArgs = {
  input: DecideEmployeeAbsenceInput;
};
...
export type MutationRemoveEmployeeOnboardingDraftArgs = {
  employeeId: Scalars['ID']['input'];
};
...
export type MutationSetTimeTrackingPeriodAnchorArgs = {
...
export type MutationUpdateLessonRecordsGroupArgs = {
...
export type MutationUpdateOrganizationFeatureToggleArgs = {
...
export type MutationUpdateRoleMembersArgs = {
  input: UpdateRoleMembersInput;
};
...
export type MutationWithdrawMyEmployeeAbsenceRequestArgs = {
  id: Scalars['ID']['input'];
};

export type MyLessonRecordStatsOutput = {
  __typename?: 'MyLessonRecordStatsOutput';
  lastRecordedAt?: Maybe<Scalars['String']['output']>;
  lessonsCount: Scalars['Int']['output'];
  studentsReached: Scalars['Int']['output'];
  todayCount: Scalars['Int']['output'];
  weekCount: Scalars['Int']['output'];
  weekDelta: Scalars['Int']['output'];
};
...
export type Organization = {
  ...
  activeLevels?: Maybe<Array<Scalars['String']['output']>>;
  billingAddressExtra?: Maybe<Scalars['String']['output']>;
  billingAddressSameAsLocation?: Maybe<Scalars['Boolean']['output']>;
  billingAmountChf?: Maybe<Scalars['Float']['output']>;
  ...
  careModel?: Maybe<Scalars['String']['output']>;
  city?: Maybe<Scalars['String']['output']>;
  contactEmail?: Maybe<Scalars['String']['output']>;
  ...
  contractEndsAt?: Maybe<Scalars['String']['output']>;
  country?: Maybe<Scalars['String']['output']>;
  createdAt: Scalars['DateTime']['output'];
  currentSchoolYear?: Maybe<Scalars['String']['output']>;
  ...
  name?: Maybe<Scalars['String']['output']>;
  parentMailSenderEmail?: Maybe<Scalars['String']['output']>;
  phone?: Maybe<Scalars['String']['output']>;
  ...
  suspendedById?: Maybe<Scalars['String']['output']>;
  ...
  updatedAt: Scalars['DateTime']['output'];
  userLicenseLimit?: Maybe<Scalars['Int']['output']>;
...
export type OrganizationAuditLogPage = {
  __typename?: 'OrganizationAuditLogPage';
  items: Array<OrganizationAuditLog>;
  total: Scalars['Int']['output'];
};

export type OrganizationFeatureToggle = {
  __typename?: 'OrganizationFeatureToggle';
...
export type OrganizationOverviewRow = {
  __typename?: 'OrganizationOverviewRow';
  childCount: Scalars['Int']['output'];
  enabledFeatureCount: Scalars['Int']['output'];
...
export type OrganizationUsage = {
  ...
  activeUsersLast30Days: Scalars['Int']['output'];
  avgLoginsPerDay: Scalars['Float']['output'];
  childCount: Scalars['Int']['output'];
...
export type OrganizationsOverview = {
  __typename?: 'OrganizationsOverview';
  rows: Array<OrganizationOverviewRow>;
  stats: OrganizationsOverviewStats;
};

export type OrganizationsOverviewStats = {
  __typename?: 'OrganizationsOverviewStats';
  activeCount: Scalars['Int']['output'];
  suspendedCount: Scalars['Int']['output'];
...
export type Query = {
  ...
  companyVacationsForEmployee: Array<EmployeeCompanyVacation>;
  ...
  curriculumLevelsByOrg: Array<CurriculumLevel>;
  ...
  employeeMonthlyTimeTracking: Array<MonthlyTimeTrackingGroup>;
  ...
  employeeVacationSegments: Array<EmployeeVacationSegment>;
  ...
  lessonRecordsByIds: Array<LessonRecord>;
  ...
  organization: Organization;
  organizationAuditLog: OrganizationAuditLogPage;
  organizationFeatureToggles: Array<OrganizationFeatureToggle>;
  organizationOwner?: Maybe<OrganizationOwner>;
  ...
  recentLessonRecords: Array<RecentLessonRecordOutput>;
  ...
  timeTrackingPeriodAnchor: Scalars['String']['output'];
...
export type QueryCurriculumLevelsByOrgArgs = {
  includeArchived?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type QueryEmployeeMonthlyTimeTrackingArgs = {
  employeeId: Scalars['ID']['input'];
  from: Scalars['String']['input'];
  locale?: InputMaybe<Scalars['String']['input']>;
  to: Scalars['String']['input'];
...
export type QueryEmployeeVacationSegmentsArgs = {
  employeeId: Scalars['ID']['input'];
};
...
export type QueryLessonRecordsByIdsArgs = {
  ids: Array<Scalars['ID']['input']>;
};
...
export type QueryLessonsByOrgArgs = {
  curriculumLevelId?: InputMaybe<Scalars['ID']['input']>;
  forSchoolClassId?: InputMaybe<Scalars['ID']['input']>;
  forStudentId?: InputMaybe<Scalars['ID']['input']>;
  includeArchived?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type QueryMyAbsenceCategoryQuotaArgs = {
  absenceCategoryId: Scalars['ID']['input'];
  date?: InputMaybe<Scalars['String']['input']>;
};
...
export type QueryMyMonthlyTimeTrackingArgs = {
  from: Scalars['String']['input'];
  locale?: InputMaybe<Scalars['String']['input']>;
  to: Scalars['String']['input'];
};
...
export type QueryOrganizationFeatureTogglesArgs = {
  organizationId: Scalars['ID']['input'];
};


export type QueryOrganizationOwnerArgs = {
  organizationId: Scalars['String']['input'];
};
...
export type QueryRecentLessonRecordsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: Scalars['String']['input'];
};
...
export type QuerySimulateEmployeeWorkTimeBalanceArgs = {
  contractEndDateOverride?: InputMaybe<Scalars['String']['input']>;
  employeeId: Scalars['ID']['input'];
  from: Scalars['String']['input'];
  to: Scalars['String']['input'];
};
...
export type QueryTeamShiftsArgs = {
  teamId: Scalars['ID']['input'];
};
...
export type RecentLessonRecordOutput = {
  __typename?: 'RecentLessonRecordOutput';
  ...
  students: Array<RecentLessonRecordStudentOutput>;
};

export type RecentLessonRecordStudentOutput = {
  __typename?: 'RecentLessonRecordStudentOutput';
  firstName: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  lastName: Scalars['String']['output'];
};
...
export type SetupStatus = {
  ...
  requiredRemaining: Scalars['Int']['output'];
  steps: Array<SetupStep>;
};

export type SetupStep = {
  __typename?: 'SetupStep';
  count: Scalars['Int']['output'];
...
export type ShiftPreference = {
  __typename?: 'ShiftPreference';
  level: ShiftPreferenceLevel;
  shiftId: Scalars['ID']['output'];
};

export type ShiftPreferenceInput = {
  level: ShiftPreferenceLevel;
  shiftId: Scalars['ID']['input'];
};
...
export type TransferStudentInput = {
  gradeLevelId?: InputMaybe<Scalars['ID']['input']>;
  studentId: Scalars['ID']['input'];
...
export type UpdateOrganizationFeatureToggleInput = {
  enabled: Scalars['Boolean']['input'];
  featureKey: Scalars['String']['input'];
  organizationId: Scalars['ID']['input'];
};
...
export type UpdateRoleMembersInput = {
...
export type VacationBalance = {
  ...
  reductionDays: Scalars['Float']['output'];
...
export type WeekdayWorkloadsInput = {
  fri?: InputMaybe<Scalars['Float']['input']>;
  mon?: InputMaybe<Scalars['Float']['input']>;
  sat?: InputMaybe<Scalars['Float']['input']>;
  sun?: InputMaybe<Scalars['Float']['input']>;
  thu?: InputMaybe<Scalars['Float']['input']>;
  tue?: InputMaybe<Scalars['Float']['input']>;
  wed?: InputMaybe<Scalars['Float']['input']>;
};
...
export type OrganizationNameQuery = { __typename?: 'Query', organization: { __typename?: 'Organization', id: string, name?: string | null } };
...
export type EditMessageMutation = { __typename?: 'Mutation', editMessage: { __typename?: 'Message', id: string, body: string, editedAt?: any | null } };

export type ChatContactsQueryVariables = Exact<{ [key: string]: never; }>;


export type ChatContactsQuery = { __typename?: 'Query', chatContacts: Array<{ __typename?: 'Membership', id: string, user?: { __typename?: 'User', id: string, firstName: string, lastName: string } | null }> };
...
export type ConversationMessagesQuery = { __typename?: 'Query', conversationMessages: Array<{ __typename?: 'Message', id: string, body: string, createdAt: any, editedAt?: any | null, senderMembershipId?: string | null, sender?: { __typename?: 'Membership', id: string, user?: { __typename?: 'User', id: string, firstName: string, lastName: string } | null } | null, attachments?: Array<{ __typename?: 'MessageAttachment', id: string, originalName: string, mimeType: string, sizeBytes: number }> | null }> };
...
export type SendMessageMutation = { __typename?: 'Mutation', sendMessage: { __typename?: 'Message', id: string, body: string, createdAt: any, senderMembershipId?: string | null, sender?: { __typename?: 'Membership', id: string, user?: { __typename?: 'User', id: string, firstName: string, lastName: string } | null } | null, attachments?: Array<{ __typename?: 'MessageAttachment', id: string, originalName: string, mimeType: string, sizeBytes: number }> | null } };
...
export type MessageAddedSubscription = { __typename?: 'Subscription', messageAdded: { __typename?: 'Message', id: string, body: string, createdAt: any, editedAt?: any | null, senderMembershipId?: string | null, sender?: { __typename?: 'Membership', id: string, user?: { __typename?: 'User', id: string, firstName: string, lastName: string } | null } | null, attachments?: Array<{ __typename?: 'MessageAttachment', id: string, originalName: string, mimeType: string, sizeBytes: number }> | null } };
...
export type MessageDeletedSubscription = { __typename?: 'Subscription', messageDeleted: { __typename?: 'MessageDeleted', id: string, conversationId: string } };
...
export type GetCurriculumLevelsByOrgQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurriculumLevelsByOrgQuery = { __typename?: 'Query', curriculumLevelsByOrg: Array<{ __typename?: 'CurriculumLevel', id: string, slug: string, position: number, isArchived: boolean, translations?: Array<{ __typename?: 'CurriculumLevelTranslation', locale: CurriculumLocale, name: string }> | null }> };
...
export type EmployeeAbsenceCategoriesByOrgIdFullQuery = { __typename?: 'Query', employeeAbsenceCategoriesByOrgId: Array<{ __typename?: 'EmployeeAbsenceCategory', id: string, systemCode?: SystemEmployeeAbsenceCategory | null, isSystem: boolean, isActive: boolean, countsAsWorkTime: boolean, isPaid: boolean, affectsVacationBalance: boolean, defaultIsVacationCapable: boolean, reducesVacationEntitlementAfterDays?: number | null, requiresCertificate: boolean, certificateRequiredFromDay?: number | null, maxDaysPerYear?: number | null, allowsDateRange: boolean, entryPrecision: AbsenceEntryPrecision, syncToCalendar: boolean, calendarTitleTemplate?: string | null, maxDaysPerRequest?: number | null, maxDaysAhead?: number | null, defaultPercentage: number, requiresApproval: boolean, color?: string | null, iconName?: string | null, sortOrder: number, translations?: Array<{ __typename?: 'EmployeeAbsenceCategoryTranslation', locale: Locale, name: string, description?: string | null }> | null }> };
...
export type GetEmployeeAbsenceCategoriesByOrgIdQuery = { __typename?: 'Query', employeeAbsenceCategoriesByOrgId: Array<{ __typename?: 'EmployeeAbsenceCategory', id: string, systemCode?: SystemEmployeeAbsenceCategory | null, requiresApproval: boolean, allowsDateRange: boolean, entryPrecision: AbsenceEntryPrecision, maxDaysPerRequest?: number | null, maxDaysAhead?: number | null, maxDaysPerYear?: number | null, isActive: boolean, translations?: Array<{ __typename?: 'EmployeeAbsenceCategoryTranslation', locale: Locale, name: string }> | null }> };

export type GetMyAbsenceCategoryQuotaQueryVariables = Exact<{
  absenceCategoryId: Scalars['ID']['input'];
  date?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type EmployeeContractsByEmployeeIdQuery = { __typename?: 'Query', employeeContractsByEmployeeId: Array<{ __typename?: 'EmployeeContract', id: string, employeeId: string, startDate: string, endDate?: string | null, probationEndDate?: string | null, contractType?: EmployeeContractType | null, position?: string | null, supervisorMembershipId?: string | null, workloadPercent?: number | null, weeklyHours?: string | null, grossSalary?: number | null, hourlyRate?: number | null, paymentInterval?: EmployeePaymentInterval | null, has13thSalary?: boolean | null, annualVacationDays?: number | null, remainingVacationDays?: string | null, notes?: string | null, documentUrl?: string | null, isActive: boolean, worksShifts: boolean, shiftWeekdays: Array<string>, shiftPreferences: Array<{ __typename?: 'ShiftPreference', shiftId: string, level: ShiftPreferenceLevel }>, weekdayWorkloads?: { __typename?: 'WeekdayWorkloads', mon?: number | null, tue?: number | null, wed?: number | null, thu?: number | null, fri?: number | null, sat?: number | null, sun?: number | null } | null, weekdayTimeWindows?: { __typename?: 'WeekdayTimeWindows', mon?: Array<{ __typename?: 'TimeWindow', start: string, end: string }> | null, tue?: Array<{ __typename?: 'TimeWindow', start: string, end: string }> | null, wed?: Array<{ __typename?: 'TimeWindow', start: string, end: string }> | null, thu?: Array<{ __typename?: 'TimeWindow', start: string, end: string }> | null, fri?: Array<{ __typename?: 'TimeWindow', start: string, end: string }> | null, sat?: Array<{ __typename?: 'TimeWindow', start: string, end: string }> | null, sun?: Array<{ __typename?: 'TimeWindow', start: string, end: string }> | null } | null }> };
...
export type UpsertEmployeeOnboardingDraftMutation = { __typename?: 'Mutation', upsertEmployeeOnboardingDraft: { __typename?: 'Employee', id: string, status: EmployeeStatus, invitationStatus: EmployeeInvitationStatus, version: number } };
...
export type FinalizeEmployeeOnboardingMutation = { __typename?: 'Mutation', finalizeEmployeeOnboarding: { __typename?: 'Employee', id: string, status: EmployeeStatus, invitationStatus: EmployeeInvitationStatus, version: number } };
...
export type SendEmployeeInvitationMutation = { __typename?: 'Mutation', sendEmployeeInvitation: { __typename?: 'Employee', id: string, invitationStatus: EmployeeInvitationStatus, version: number } };

export type RemoveEmployeeDraftMutationVariables = Exact<{
  employeeId: Scalars['ID']['input'];
}>;


export type RemoveEmployeeDraftMutation = { __typename?: 'Mutation', removeEmployeeOnboardingDraft: boolean };
...
export type GetEmployeeByIdQuery = { __typename?: 'Query', employeeById: { __typename?: 'Employee', id: string, status: EmployeeStatus, version: number, accountLinkStatus: string, timeTrackingEnabled: boolean, profile: { __typename?: 'EmployeeProfile', firstName?: string | null, lastName?: string | null, title?: string | null, dateOfBirth?: string | null, socialSecurityNumber?: string | null, street?: string | null, houseNumber?: string | null, addressLine2?: string | null, postalCode?: string | null, city?: string | null, country?: string | null, privateEmail?: string | null, avatarUrl?: string | null, language?: string | null, email?: string | null }, teamMembers?: Array<{ __typename?: 'TeamMember', team?: { __typename?: 'Team', id: string, name: string } | null }> | null, membership: { __typename?: 'Membership', id: string, persona: Persona, contactPhone?: string | null, contactPhone2?: string | null, language?: string | null, userEmail?: { __typename?: 'UserEmail', email: string } | null, user?: { __typename?: 'User', id: string, title?: string | null, firstName: string, lastName: string, dateOfBirth?: string | null, socialSecurityNumber?: string | null, street?: string | null, houseNumber?: string | null, addressLine2?: string | null, postalCode?: string | null, city?: string | null, country?: string | null, privateEmail?: string | null, avatarUrl?: string | null, language?: string | null, userEmails: Array<{ __typename?: 'UserEmail', email: string, isPrimary: boolean }> } | null, organization: { __typename?: 'Organization', id: string, name?: string | null }, roles?: Array<{ __typename?: 'Role', id: string, name?: string | null, systemCode?: SystemRole | null }> | null } } };
...
export type GetEmployeesQuery = { __typename?: 'Query', employeesByOrgId: Array<{ __typename?: 'Employee', workloadPercent?: number | null, timeBalanceMinutes?: number | null, profile: { __typename?: 'EmployeeProfile', firstName?: string | null, lastName?: string | null, email?: string | null, avatarUrl?: string | null }, membership: { __typename?: 'Membership', id: string, persona: Persona, contactPhone?: string | null, employee?: { __typename?: 'Employee', isActive: boolean, timeTrackingEnabled: boolean, id: string, status: EmployeeStatus, invitationStatus: EmployeeInvitationStatus, accountLinkStatus: string } | null, user?: { __typename?: 'User', firstName: string, id: string, lastName: string, userEmails: Array<{ __typename?: 'UserEmail', email: string, isPrimary: boolean }> } | null }, teamMembers?: Array<{ __typename?: 'TeamMember', team?: { __typename?: 'Team', id: string, name: string } | null }> | null }> };
...
export type CreateGradeLevelMutation = { __typename?: 'Mutation', createGradeLevel: { __typename?: 'GradeLevel', id: string, name: string, parentId?: string | null, curriculumLevelId?: string | null, color?: string | null, shortCode?: string | null, ageMin?: number | null, ageMax?: number | null, sortOrder: number } };
...
export type GetGradeLevelsQuery = { __typename?: 'Query', gradeLevelsByOrgId: Array<{ __typename?: 'GradeLevel', id: string, name: string, parentId?: string | null, curriculumLevelId?: string | null, color?: string | null, shortCode?: string | null, ageMin?: number | null, ageMax?: number | null, sortOrder: number, classCount?: number | null, studentCount?: number | null }> };
...
export type UpdateGradeLevelMutation = { __typename?: 'Mutation', updateGradeLevel: { __typename?: 'GradeLevel', id: string, name: string, parentId?: string | null, curriculumLevelId?: string | null, color?: string | null, shortCode?: string | null, ageMin?: number | null, ageMax?: number | null, sortOrder: number } };
...
export type BulkUpdateOrganizationFeatureTogglesMutationVariables = Exact<{
  input: BulkUpdateOrganizationFeatureTogglesInput;
}>;


export type BulkUpdateOrganizationFeatureTogglesMutation = { __typename?: 'Mutation', bulkUpdateOrganizationFeatureToggles: Array<{ __typename?: 'OrganizationFeatureToggle', featureKey: string, enabled: boolean }> };

export type ChangeOrganizationPlanMutationVariables = Exact<{
  input: ChangeOrganizationPlanInput;
}>;


export type ChangeOrganizationPlanMutation = { __typename?: 'Mutation', changeOrganizationPlan: { __typename?: 'Organization', id: string, plan?: string | null, userLicenseLimit?: number | null, contractEndsAt?: string | null, billingInterval?: string | null, billingAmountChf?: number | null } };
...
export type ExportOrganizationDataMutationVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type ExportOrganizationDataMutation = { __typename?: 'Mutation', exportOrganizationData: { __typename?: 'ExportOrganizationDataResult', jobId: string, status: string } };

export type GetOrganizationAuditLogQueryVariables = Exact<{
  organizationId: Scalars['String']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type GetOrganizationAuditLogQuery = { __typename?: 'Query', organizationAuditLog: { __typename?: 'OrganizationAuditLogPage', total: number, items: Array<{ __typename?: 'OrganizationAuditLog', id: string, action: string, createdAt: any, actorUser?: { __typename?: 'User', id: string, firstName: string, lastName: string } | null }> } };
...
export type OrganizationQuery = { __typename?: 'Query', organization: { __typename?: 'Organization', id: string, name?: string | null, subdomain?: string | null, domain?: string | null, street?: string | null, zip?: string | null, city?: string | null, country?: string | null, phone?: string | null, email?: string | null, website?: string | null, timezone: string, latitude?: number | null, longitude?: number | null, isActive: boolean, shortCode?: string | null, sponsorship?: string | null, schoolType?: string | null, careModel?: string | null, legalEntity?: string | null, language?: string | null, logoUrl?: string | null, billingAddressSameAsLocation?: boolean | null, billingAddressExtra?: string | null, contactSalutation?: string | null, contactTitle?: string | null, contactFirstName?: string | null, contactLastName?: string | null, contactRole?: string | null, contactEmail?: string | null, contactPhone?: string | null, billingEmail?: string | null, parentMailSenderEmail?: string | null, currentSchoolYear?: string | null, activeLevels?: Array<string> | null, plan?: string | null, userLicenseLimit?: number | null, contractEndsAt?: string | null, billingInterval?: string | null, billingAmountChf?: number | null, storageLimitGb?: number | null, lifecycleStatus?: string | null, trialEndsAt?: string | null, suspendedReason?: string | null, bvgProvider?: string | null, bvgContactPhone?: string | null, uvgProvider?: string | null, uvgContactPhone?: string | null, dailySicknessProvider?: string | null, dailySicknessContactPhone?: string | null, createdAt: any, updatedAt: any } };

export type OrganizationFeatureTogglesQueryVariables = Exact<{
  organizationId: Scalars['ID']['input'];
}>;


export type OrganizationFeatureTogglesQuery = { __typename?: 'Query', organizationFeatureToggles: Array<{ __typename?: 'OrganizationFeatureToggle', featureKey: string, enabled: boolean }> };
...
export type GetOrganizationOwnerQuery = { __typename?: 'Query', organizationOwner?: { __typename?: 'OrganizationOwner', userId: string, firstName: string, lastName: string, email: string } | null };

export type GetOrganizationUsageQueryVariables = Exact<{
  organizationId: Scalars['String']['input'];
}>;


export type GetOrganizationUsageQuery = { __typename?: 'Query', organizationUsage: { __typename?: 'OrganizationUsage', userCount: number, childCount: number, storageUsedGb: number, activeUsersLast30Days: number, lastLoginAt?: any | null, avgLoginsPerDay: number } };

export type GetOrganizationsOverviewQueryVariables = Exact<{ [key: string]: never; }>;


export type GetOrganizationsOverviewQuery = { __typename?: 'Query', organizationsOverview: { __typename?: 'OrganizationsOverview', stats: { __typename?: 'OrganizationsOverviewStats', activeCount: number, trialCount: number, totalUserCount: number, suspendedCount: number }, rows: Array<{ __typename?: 'OrganizationOverviewRow', memberCount: number, childCount: number, enabledFeatureCount: number, trialDaysRemaining?: number | null, organization: { __typename?: 'Organization', id: string, name?: string | null, shortCode?: string | null, plan?: string | null, userLicenseLimit?: number | null, lifecycleStatus?: string | null, suspendedReason?: string | null, createdAt: any } }> } };
...
export type ReactivateOrganizationMutation = { __typename?: 'Mutation', reactivateOrganization: { __typename?: 'Organization', id: string, lifecycleStatus?: string | null, suspendedReason?: string | null } };
...
export type SuspendOrganizationMutation = { __typename?: 'Mutation', suspendOrganization: { __typename?: 'Organization', id: string, lifecycleStatus?: string | null, suspendedReason?: string | null } };

export type UpdateOrganizationFeatureToggleMutationVariables = Exact<{
  input: UpdateOrganizationFeatureToggleInput;
}>;


export type UpdateOrganizationFeatureToggleMutation = { __typename?: 'Mutation', updateOrganizationFeatureToggle: Array<{ __typename?: 'OrganizationFeatureToggle', featureKey: string, enabled: boolean }> };
...
export type MembershipsByOrgIdQuery = { __typename?: 'Query', membershipsByOrgId: Array<{ __typename?: 'Membership', id: string, userId?: string | null, user?: { __typename?: 'User', firstName: string, lastName: string, isSuperAdmin?: boolean | null } | null, userEmail?: { __typename?: 'UserEmail', email: string } | null }> };
...
export type ProjectByIdQuery = { __typename?: 'Query', projectById: { __typename?: 'Project', id: string, title: string, description?: string | null, status: ProjectStatus, color?: string | null, dueDate?: string | null, isArchived: boolean, createdAt: any, taskStats: { __typename?: 'ProjectTaskStats', total: number, done: number }, members?: Array<{ __typename?: 'ProjectMember', id: string, role: ProjectMemberRole, membership?: { __typename?: 'Membership', id: string, userId?: string | null, user?: { __typename?: 'User', firstName: string, lastName: string } | null, userEmail?: { __typename?: 'UserEmail', email: string } | null } | null }> | null } };
...
export type CreateLessonRecordsBulkMutation = { __typename?: 'Mutation', createLessonRecordsBulk: Array<{ __typename?: 'LessonRecord', id: string, studentId: string, lessonId: string, recordedAt: string, status: LessonRecordStatus, durationMinutes?: number | null, note?: string | null }> };

export type DeleteLessonRecordsGroupMutationVariables = Exact<{
  recordIds: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type DeleteLessonRecordsGroupMutation = { __typename?: 'Mutation', deleteLessonRecordsGroup: boolean };
...
export type LessonRecordsByIdsQueryVariables = Exact<{
  ids: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type LessonRecordsByIdsQuery = { __typename?: 'Query', lessonRecordsByIds: Array<{ __typename?: 'LessonRecord', id: string, studentId: string, lessonId: string, recordedAt: string, status: LessonRecordStatus, durationMinutes?: number | null, note?: string | null, student?: { __typename?: 'Student', firstName: string, lastName: string } | null }> };

export type GetLessonsForRecordKeepingQueryVariables = Exact<{
  forSchoolClassId?: InputMaybe<Scalars['ID']['input']>;
}>;
...
export type MyLessonRecordStatsQueryVariables = Exact<{ [key: string]: never; }>;


export type MyLessonRecordStatsQuery = { __typename?: 'Query', myLessonRecordStats: { __typename?: 'MyLessonRecordStatsOutput', todayCount: number, weekCount: number, weekDelta: number, studentsReached: number, lessonsCount: number, lastRecordedAt?: string | null } };
...
export type RecentLessonRecordsQueryVariables = Exact<{
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
}>;


export type RecentLessonRecordsQuery = { __typename?: 'Query', recentLessonRecords: Array<{ __typename?: 'RecentLessonRecordOutput', lessonId: string, lessonName?: string | null, areaName?: string | null, studentCount: number, recordIds: Array<string>, status: LessonRecordStatus, durationMinutes?: number | null, recordedAt: string, students: Array<{ __typename?: 'RecentLessonRecordStudentOutput', id: string, firstName: string, lastName: string }> }> };
...
export type UpdateLessonRecordsGroupMutationVariables = Exact<{
  input: UpdateLessonRecordsGroupInput;
}>;


export type UpdateLessonRecordsGroupMutation = { __typename?: 'Mutation', updateLessonRecordsGroup: Array<{ __typename?: 'LessonRecord', id: string, studentId: string }> };
...
export type GetRolesByOrgIdQuery = { __typename?: 'Query', rolesByOrgId: Array<{ __typename?: 'Role', id: string, name?: string | null, systemCode?: SystemRole | null, isSystem: boolean, permissions?: Array<{ __typename?: 'Permission', id: string, code: PermissionCode, name: string }> | null, memberships?: Array<{ __typename?: 'Membership', id: string, user?: { __typename?: 'User', id: string, firstName: string, lastName: string } | null }> | null }> };
...
export type UpdateRoleMembersMutationVariables = Exact<{
  input: UpdateRoleMembersInput;
}>;


export type UpdateRoleMembersMutation = { __typename?: 'Mutation', updateRoleMembers: { __typename?: 'Role', id: string } };
...
export type GetSchoolClassByIdQuery = { __typename?: 'Query', schoolClassById: { __typename?: 'SchoolClass', id: string, name: string, shortCode?: string | null, enrolledCount?: number | null, color?: string | null, description?: string | null, sortOrder: number, maxCapacity?: number | null, room?: string | null, isActive: boolean, teacherAssignments?: Array<{ __typename?: 'SchoolClassTeacher', id: string, employeeId: string, role: SchoolClassTeacherRole, workloadPercent?: number | null, validFrom: string, validTo?: string | null, employee: { __typename?: 'Employee', id: string, firstName: string, lastName: string } }> | null, gradeLevels?: Array<{ __typename?: 'GradeLevel', id: string, name: string }> | null, teachers?: Array<{ __typename?: 'Employee', id: string, firstName: string, lastName: string }> | null } };

export type GetSchoolClassesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSchoolClassesQuery = { __typename?: 'Query', schoolClassesByOrgId: Array<{ __typename?: 'SchoolClass', id: string, name: string, color?: string | null, description?: string | null, sortOrder: number, maxCapacity?: number | null, room?: string | null, enrolledCount?: number | null, isActive: boolean, gradeLevels?: Array<{ __typename?: 'GradeLevel', id: string, name: string, ageMin?: number | null, ageMax?: number | null }> | null, teachers?: Array<{ __typename?: 'Employee', id: string, firstName: string, lastName: string }> | null, teacherAssignments?: Array<{ __typename?: 'SchoolClassTeacher', id: string, employeeId: string, role: SchoolClassTeacherRole, workloadPercent?: number | null, employee: { __typename?: 'Employee', id: string, firstName: string, lastName: string } }> | null }> };

export type GetSchoolYearQueryVariables = Exact<{
  date?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetSchoolYearQuery = { __typename?: 'Query', schoolYear: { __typename?: 'SchoolYear', start: string, end: string, startYear: number, label: string } };

export type GetTeachersByOrgIdQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTeachersByOrgIdQuery = { __typename?: 'Query', teachersByOrgId: Array<{ __typename?: 'TeacherOption', id: string, firstName: string, lastName: string, userId?: string | null }> };
...
export type GetOrganizationSetupStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type GetOrganizationSetupStatusQuery = { __typename?: 'Query', organizationSetupStatus: { __typename?: 'SetupStatus', complete: boolean, requiredRemaining: number, steps: Array<{ __typename?: 'SetupStep', key: string, done: boolean, required: boolean, count: number }> } };
...
export type KanbanSchoolClassesQuery = { __typename?: 'Query', schoolClassesByOrgId: Array<{ __typename?: 'SchoolClass', id: string, name: string, color?: string | null, maxCapacity?: number | null, sortOrder: number, isActive: boolean, gradeLevels?: Array<{ __typename?: 'GradeLevel', id: string, name: string, parentId?: string | null, sortOrder: number }> | null }> };

export type KanbanUnassignedStudentsQueryVariables = Exact<{ [key: string]: never; }>;


export type KanbanUnassignedStudentsQuery = { __typename?: 'Query', unassignedStudents: Array<{ __typename?: 'Student', id: string, firstName: string, lastName: string, dateOfBirth?: string | null, isActive: boolean }> };

export type KanbanGradeLevelsQueryVariables = Exact<{ [key: string]: never; }>;


export type KanbanGradeLevelsQuery = { __typename?: 'Query', gradeLevelsByOrgId: Array<{ __typename?: 'GradeLevel', id: string, name: string, parentId?: string | null, sortOrder: number }> };
...
export type KanbanClassroomStudentsQuery = { __typename?: 'Query', activeEnrollmentsBySchoolClassId: Array<{ __typename?: 'SchoolClassEnrollment', id: string, gradeLevelId?: string | null, student: { __typename?: 'Student', id: string, firstName: string, lastName: string, dateOfBirth?: string | null, isActive: boolean } }> };
...
export type GetStudentByIdQuery = { __typename?: 'Query', studentById: { __typename?: 'Student', id: string, firstName: string, lastName: string, dateOfBirth?: string | null, gender?: Gender | null, enrollmentDate?: string | null, exitDate?: string | null, notes?: string | null, preferredName?: string | null, photoUrl?: string | null, placeOfBirth?: string | null, firstLanguages?: Array<string> | null, familyLanguages?: Array<string> | null, religion?: string | null, socialSecurityNumber?: string | null, externalStudentId?: string | null, nationalities?: Array<string> | null, isActive: boolean } };
...
export type GetAllTeamMembersQuery = { __typename?: 'Query', teamMembersByOrgId: Array<{ __typename?: 'TeamMember', id: string, role: TeamMemberRole, team?: { __typename?: 'Team', id: string } | null, employee?: { __typename?: 'Employee', id: string, isActive: boolean, firstName: string, lastName: string, membership: { __typename?: 'Membership', user?: { __typename?: 'User', id: string, firstName: string, lastName: string, userEmails: Array<{ __typename?: 'UserEmail', email: string, isPrimary: boolean }> } | null } } | null }> };
...
export type GetTeamMembersQuery = { __typename?: 'Query', teamMembersByTeamId: Array<{ __typename?: 'TeamMember', id: string, role: TeamMemberRole, employee?: { __typename?: 'Employee', id: string, isActive: boolean, firstName: string, lastName: string, membership: { __typename?: 'Membership', user?: { __typename?: 'User', id: string, firstName: string, lastName: string, userEmails: Array<{ __typename?: 'UserEmail', email: string, isPrimary: boolean }> } | null } } | null }> };
...
export type CompanyVacationsForEmployeeQuery = { __typename?: 'Query', companyVacationsForEmployee: Array<{ __typename?: 'EmployeeCompanyVacation', id: string, companyVacationId: string, name: string, startDate: string, endDate: string, effectiveDays: number, periodLabel: string, periodStartDate: string, periodEndDate: string, isSplit: boolean, holidays: Array<{ __typename?: 'CompanyVacationHoliday', date: string, name: string, paidPercentage: number, isWeekend: boolean }> }> };
...
export type EmployeeVacationSegmentsQueryVariables = Exact<{
  employeeId: Scalars['ID']['input'];
}>;


export type EmployeeVacationSegmentsQuery = { __typename?: 'Query', employeeVacationSegments: Array<{ __typename?: 'EmployeeVacationSegment', id: string, employeeVacationId: string, name?: string | null, startDate: string, endDate: string, effectiveDays: number, periodLabel: string, periodStartDate: string, periodEndDate: string, isSplit: boolean, holidays: Array<{ __typename?: 'CompanyVacationHoliday', date: string, name: string, paidPercentage: number, isWeekend: boolean }> }> };

export type CreateEmployeeVacationMutationVariables = Exact<{
  input: CreateEmployeeVacationInput;
}>;


export type CreateEmployeeVacationMutation = { __typename?: 'Mutation', createEmployeeVacation: { __typename?: 'EmployeeVacation', id: string, accrualType: EmployeeVacationAccrualType, remark?: string | null } };

export type UpdateEmployeeVacationMutationVariables = Exact<{
  input: UpdateEmployeeVacationInput;
}>;


export type UpdateEmployeeVacationMutation = { __typename?: 'Mutation', updateEmployeeVacation: { __typename?: 'EmployeeVacation', id: string } };

export type DeleteEmployeeVacationMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type DeleteEmployeeVacationMutation = { __typename?: 'Mutation', deleteEmployeeVacation: boolean };

export type EmployeeMonthlyTimeTrackingQueryVariables = Exact<{
  employeeId: Scalars['ID']['input'];
  from: Scalars['String']['input'];
  to: Scalars['String']['input'];
  locale?: InputMaybe<Scalars['String']['input']>;
...
export type EmployeeMonthlyTimeTrackingQuery = { __typename?: 'Query', employeeMonthlyTimeTracking: Array<{ __typename?: 'MonthlyTimeTrackingGroup', year: number, month: number, workedMinutes: number, plannedMinutes: number, days: Array<{ __typename?: 'DailyTimeTracking', date: string, kind: DailyTimeTrackingKind, label?: string | null, color?: string | null, workMinutes: number, plannedMinutes: number, entries?: Array<{ __typename?: 'DailyTimeTrackingEntry', id: string, startedAt: any, endedAt?: any | null, breakMinutes?: number | null, workMinutes?: number | null, notes?: string | null }> | null }> }> };
...
export type MyTimeTrackingQuery = { __typename?: 'Query', myMissingRecordDays: Array<string>, myWorkTimeBalance: { __typename?: 'WorkTimeBalance', employeeId: string, fromDate: string, toDate: string, plannedMinutes: number, workedMinutes: number, vacationMinutes: number, absenceMinutes: number, actualMinutes: number, differenceMinutes: number, openingWorkMinutes: number, paidOvertimeMinutes: number, netBalanceMinutes: number, vacationDaysUsed: number, absenceDaysCount: number }, myVacationBalance: { __typename?: 'VacationBalance', entitlementDays: number, openingDays: number, usedDays: number, reductionDays: number, remainingDays: number }, timeTrackingByEmployeeId: Array<{ __typename?: 'TimeTracking', id: string, startedAt: any, endedAt?: any | null, breakMinutes?: number | null, workMinutes?: number | null, notes?: string | null, entryDate: string, source: TimeTrackingSource }>, myMonthlyTimeTracking: Array<{ __typename?: 'MonthlyTimeTrackingGroup', year: number, month: number, workedMinutes: number, days: Array<{ __typename?: 'DailyTimeTracking', date: string, kind: DailyTimeTrackingKind, label?: string | null, color?: string | null, workMinutes: number, entries?: Array<{ __typename?: 'DailyTimeTrackingEntry', id: string, startedAt: any, endedAt?: any | null, breakMinutes?: number | null, workMinutes?: number | null, notes?: string | null }> | null }> }> };
...
export type TimeTrackingPeriodAnchorQueryVariables = Exact<{ [key: string]: never; }>;


export type TimeTrackingPeriodAnchorQuery = { __typename?: 'Query', timeTrackingPeriodAnchor: string };

export type SetTimeTrackingPeriodAnchorMutationVariables = Exact<{
  anchor: Scalars['String']['input'];
}>;


export type SetTimeTrackingPeriodAnchorMutation = { __typename?: 'Mutation', setTimeTrackingPeriodAnchor: string };
...
export type TimeTrackingSettingsQuery = { __typename?: 'Query', holidays: Array<{ __typename?: 'Holiday', id: string, date: string, name: string, paidPercentage: number, repeatsYearly: boolean }>, companyVacations: Array<{ __typename?: 'CompanyVacation', id: string, name: string, startDate: string, endDate: string, effectiveDays: number, holidays: Array<{ __typename?: 'CompanyVacationHoliday', date: string, name: string, paidPercentage: number, isWeekend: boolean }> }> };
...
export type UpdateCompanyVacationMutationVariables = Exact<{
  input: UpdateCompanyVacationInput;
}>;


export type UpdateCompanyVacationMutation = { __typename?: 'Mutation', updateCompanyVacation: { __typename?: 'CompanyVacation', id: string } };
...
export type ShiftsQueryVariables = Exact<{ [key: string]: never; }>;


export type ShiftsQuery = { __typename?: 'Query', shifts: Array<{ __typename?: 'Shift', id: string, name: string, startTime: string, endTime: string, color?: string | null, sortOrder: number, teamIds: Array<string>, breaks: Array<{ __typename?: 'ShiftBreak', startTime: string, endTime: string }> }> };

export type TeamShiftsQueryVariables = Exact<{
  teamId: Scalars['ID']['input'];
}>;


export type TeamShiftsQuery = { __typename?: 'Query', teamShifts: Array<{ __typename?: 'Shift', id: string, name: string, startTime: string, endTime: string, color?: string | null, sortOrder: number, teamIds: Array<string>, breaks: Array<{ __typename?: 'ShiftBreak', startTime: string, endTime: string }> }> };
...
export type CreateShiftMutation = { __typename?: 'Mutation', createShift: { __typename?: 'Shift', id: string, name: string, startTime: string, endTime: string, color?: string | null, sortOrder: number, teamIds: Array<string>, breaks: Array<{ __typename?: 'ShiftBreak', startTime: string, endTime: string }> } };
...
export type UpdateShiftMutation = { __typename?: 'Mutation', updateShift: { __typename?: 'Shift', id: string, name: string, startTime: string, endTime: string, color?: string | null, sortOrder: number, teamIds: Array<string>, breaks: Array<{ __typename?: 'ShiftBreak', startTime: string, endTime: string }> } };
...
export type DeleteShiftMutation = { __typename?: 'Mutation', deleteShift: boolean };

export type SetTeamShiftsMutationVariables = Exact<{
  input: SetTeamShiftsInput;
}>;


export type SetTeamShiftsMutation = { __typename?: 'Mutation', setTeamShifts: Array<{ __typename?: 'Shift', id: string, name: string, startTime: string, endTime: string, color?: string | null, sortOrder: number, teamIds: Array<string>, breaks: Array<{ __typename?: 'ShiftBreak', startTime: string, endTime: string }> }> };
...
export type GetAuthContextQuery = { __typename?: 'Query', authContext: { __typename?: 'AuthContextOutput', roles: Array<string>, permissions: Array<string>, orgId?: string | null, orgName?: string | null, orgTimezone?: string | null, persona?: Persona | null, theme?: string | null, isSuperAdmin: boolean, timeTrackingEnabled: boolean, isProjectMember: boolean, enabledFeatures: Array<string>, user: { __typename?: 'User', id: string, firstName: string, lastName: string, userEmails: Array<{ __typename?: 'UserEmail', id: string, email: string, isPrimary: boolean, isVerified: boolean }> }, fieldPermissions: Array<{ __typename?: 'EffectiveFieldPermissionOutput', resource: string, field: string, actions: Array<string> }> } };
...
export const OrganizationNameDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OrganizationName"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"organization"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<OrganizationNameQuery, OrganizationNameQueryVariables>;
...
export const EditMessageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"EditMessage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"messageId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"body"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"editMessage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"messageId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"messageId"}}},{"kind":"Argument","name":{"kind":"Name","value":"body"},"value":{"kind":"Variable","name":{"kind":"Name","value":"body"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"body"}},{"kind":"Field","name":{"kind":"Name","value":"editedAt"}}]}}]}}]} as unknown as DocumentNode<EditMessageMutation, EditMessageMutationVariables>;
export const ChatContactsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ChatContacts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"chatContacts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}}]}}]}}]} as unknown as DocumentNode<ChatContactsQuery, ChatContactsQueryVariables>;
...
export const MessageDeletedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"MessageDeleted"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"messageDeleted"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"conversationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conversationId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"conversationId"}}]}}]}}]} as unknown as DocumentNode<MessageDeletedSubscription, MessageDeletedSubscriptionVariables>;
...
export const GetCurriculumLevelsByOrgDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCurriculumLevelsByOrg"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"curriculumLevelsByOrg"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"isArchived"}},{"kind":"Field","name":{"kind":"Name","value":"translations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"locale"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<GetCurriculumLevelsByOrgQuery, GetCurriculumLevelsByOrgQueryVariables>;
...
export const RemoveEmployeeDraftDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveEmployeeDraft"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeEmployeeOnboardingDraft"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"employeeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}}}]}]}}]} as unknown as DocumentNode<RemoveEmployeeDraftMutation, RemoveEmployeeDraftMutationVariables>;
...
export const BulkUpdateOrganizationFeatureTogglesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"BulkUpdateOrganizationFeatureToggles"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BulkUpdateOrganizationFeatureTogglesInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bulkUpdateOrganizationFeatureToggles"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"featureKey"}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}}]}}]}}]} as unknown as DocumentNode<BulkUpdateOrganizationFeatureTogglesMutation, BulkUpdateOrganizationFeatureTogglesMutationVariables>;
export const ChangeOrganizationPlanDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ChangeOrganizationPlan"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ChangeOrganizationPlanInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"changeOrganizationPlan"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"plan"}},{"kind":"Field","name":{"kind":"Name","value":"userLicenseLimit"}},{"kind":"Field","name":{"kind":"Name","value":"contractEndsAt"}},{"kind":"Field","name":{"kind":"Name","value":"billingInterval"}},{"kind":"Field","name":{"kind":"Name","value":"billingAmountChf"}}]}}]}}]} as unknown as DocumentNode<ChangeOrganizationPlanMutation, ChangeOrganizationPlanMutationVariables>;
...
export const ExportOrganizationDataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ExportOrganizationData"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"exportOrganizationData"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"jobId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<ExportOrganizationDataMutation, ExportOrganizationDataMutationVariables>;
export const GetOrganizationAuditLogDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetOrganizationAuditLog"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"offset"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"organizationAuditLog"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"Argument","name":{"kind":"Name","value":"offset"},"value":{"kind":"Variable","name":{"kind":"Name","value":"offset"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"actorUser"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetOrganizationAuditLogQuery, GetOrganizationAuditLogQueryVariables>;
export const OrganizationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Organization"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"organization"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"subdomain"}},{"kind":"Field","name":{"kind":"Name","value":"domain"}},{"kind":"Field","name":{"kind":"Name","value":"street"}},{"kind":"Field","name":{"kind":"Name","value":"zip"}},{"kind":"Field","name":{"kind":"Name","value":"city"}},{"kind":"Field","name":{"kind":"Name","value":"country"}},{"kind":"Field","name":{"kind":"Name","value":"phone"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"website"}},{"kind":"Field","name":{"kind":"Name","value":"timezone"}},{"kind":"Field","name":{"kind":"Name","value":"latitude"}},{"kind":"Field","name":{"kind":"Name","value":"longitude"}},{"kind":"Field","name":{"kind":"Name","value":"isActive"}},{"kind":"Field","name":{"kind":"Name","value":"shortCode"}},{"kind":"Field","name":{"kind":"Name","value":"sponsorship"}},{"kind":"Field","name":{"kind":"Name","value":"schoolType"}},{"kind":"Field","name":{"kind":"Name","value":"careModel"}},{"kind":"Field","name":{"kind":"Name","value":"legalEntity"}},{"kind":"Field","name":{"kind":"Name","value":"language"}},{"kind":"Field","name":{"kind":"Name","value":"logoUrl"}},{"kind":"Field","name":{"kind":"Name","value":"billingAddressSameAsLocation"}},{"kind":"Field","name":{"kind":"Name","value":"billingAddressExtra"}},{"kind":"Field","name":{"kind":"Name","value":"contactSalutation"}},{"kind":"Field","name":{"kind":"Name","value":"contactTitle"}},{"kind":"Field","name":{"kind":"Name","value":"contactFirstName"}},{"kind":"Field","name":{"kind":"Name","value":"contactLastName"}},{"kind":"Field","name":{"kind":"Name","value":"contactRole"}},{"kind":"Field","name":{"kind":"Name","value":"contactEmail"}},{"kind":"Field","name":{"kind":"Name","value":"contactPhone"}},{"kind":"Field","name":{"kind":"Name","value":"billingEmail"}},{"kind":"Field","name":{"kind":"Name","value":"parentMailSenderEmail"}},{"kind":"Field","name":{"kind":"Name","value":"currentSchoolYear"}},{"kind":"Field","name":{"kind":"Name","value":"activeLevels"}},{"kind":"Field","name":{"kind":"Name","value":"plan"}},{"kind":"Field","name":{"kind":"Name","value":"userLicenseLimit"}},{"kind":"Field","name":{"kind":"Name","value":"contractEndsAt"}},{"kind":"Field","name":{"kind":"Name","value":"billingInterval"}},{"kind":"Field","name":{"kind":"Name","value":"billingAmountChf"}},{"kind":"Field","name":{"kind":"Name","value":"storageLimitGb"}},{"kind":"Field","name":{"kind":"Name","value":"lifecycleStatus"}},{"kind":"Field","name":{"kind":"Name","value":"trialEndsAt"}},{"kind":"Field","name":{"kind":"Name","value":"suspendedReason"}},{"kind":"Field","name":{"kind":"Name","value":"bvgProvider"}},{"kind":"Field","name":{"kind":"Name","value":"bvgContactPhone"}},{"kind":"Field","name":{"kind":"Name","value":"uvgProvider"}},{"kind":"Field","name":{"kind":"Name","value":"uvgContactPhone"}},{"kind":"Field","name":{"kind":"Name","value":"dailySicknessProvider"}},{"kind":"Field","name":{"kind":"Name","value":"dailySicknessContactPhone"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<OrganizationQuery, OrganizationQueryVariables>;
export const OrganizationFeatureTogglesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OrganizationFeatureToggles"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"organizationFeatureToggles"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"featureKey"}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}}]}}]}}]} as unknown as DocumentNode<OrganizationFeatureTogglesQuery, OrganizationFeatureTogglesQueryVariables>;
export const GetOrganizationOwnerDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetOrganizationOwner"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"organizationOwner"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"email"}}]}}]}}]} as unknown as DocumentNode<GetOrganizationOwnerQuery, GetOrganizationOwnerQueryVariables>;
export const GetOrganizationUsageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetOrganizationUsage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"organizationUsage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organizationId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"organizationId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userCount"}},{"kind":"Field","name":{"kind":"Name","value":"childCount"}},{"kind":"Field","name":{"kind":"Name","value":"storageUsedGb"}},{"kind":"Field","name":{"kind":"Name","value":"activeUsersLast30Days"}},{"kind":"Field","name":{"kind":"Name","value":"lastLoginAt"}},{"kind":"Field","name":{"kind":"Name","value":"avgLoginsPerDay"}}]}}]}}]} as unknown as DocumentNode<GetOrganizationUsageQuery, GetOrganizationUsageQueryVariables>;
export const GetOrganizationsOverviewDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetOrganizationsOverview"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"organizationsOverview"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"activeCount"}},{"kind":"Field","name":{"kind":"Name","value":"trialCount"}},{"kind":"Field","name":{"kind":"Name","value":"totalUserCount"}},{"kind":"Field","name":{"kind":"Name","value":"suspendedCount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"rows"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"memberCount"}},{"kind":"Field","name":{"kind":"Name","value":"childCount"}},{"kind":"Field","name":{"kind":"Name","value":"enabledFeatureCount"}},{"kind":"Field","name":{"kind":"Name","value":"trialDaysRemaining"}},{"kind":"Field","name":{"kind":"Name","value":"organization"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"shortCode"}},{"kind":"Field","name":{"kind":"Name","value":"plan"}},{"kind":"Field","name":{"kind":"Name","value":"userLicenseLimit"}},{"kind":"Field","name":{"kind":"Name","value":"lifecycleStatus"}},{"kind":"Field","name":{"kind":"Name","value":"suspendedReason"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetOrganizationsOverviewQuery, GetOrganizationsOverviewQueryVariables>;
...
export const ReactivateOrganizationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReactivateOrganization"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reactivateOrganization"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"lifecycleStatus"}},{"kind":"Field","name":{"kind":"Name","value":"suspendedReason"}}]}}]}}]} as unknown as DocumentNode<ReactivateOrganizationMutation, ReactivateOrganizationMutationVariables>;
...
export const SuspendOrganizationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SuspendOrganization"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SuspendOrganizationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"suspendOrganization"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"lifecycleStatus"}},{"kind":"Field","name":{"kind":"Name","value":"suspendedReason"}}]}}]}}]} as unknown as DocumentNode<SuspendOrganizationMutation, SuspendOrganizationMutationVariables>;
export const UpdateOrganizationFeatureToggleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateOrganizationFeatureToggle"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateOrganizationFeatureToggleInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateOrganizationFeatureToggle"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"featureKey"}},{"kind":"Field","name":{"kind":"Name","value":"enabled"}}]}}]}}]} as unknown as DocumentNode<UpdateOrganizationFeatureToggleMutation, UpdateOrganizationFeatureToggleMutationVariables>;
...
export const DeleteLessonRecordsGroupDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteLessonRecordsGroup"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"recordIds"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteLessonRecordsGroup"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"recordIds"},"value":{"kind":"Variable","name":{"kind":"Name","value":"recordIds"}}}]}]}}]} as unknown as DocumentNode<DeleteLessonRecordsGroupMutation, DeleteLessonRecordsGroupMutationVariables>;
...
export const LessonRecordsByIdsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"LessonRecordsByIds"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lessonRecordsByIds"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ids"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ids"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"studentId"}},{"kind":"Field","name":{"kind":"Name","value":"lessonId"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"durationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"student"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}}]}}]}}]} as unknown as DocumentNode<LessonRecordsByIdsQuery, LessonRecordsByIdsQueryVariables>;
export const GetLessonsForRecordKeepingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLessonsForRecordKeeping"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"forSchoolClassId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lessonsByOrg"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"includeArchived"},"value":{"kind":"BooleanValue","value":false}},{"kind":"Argument","name":{"kind":"Name","value":"forSchoolClassId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"forSchoolClassId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"lessonType"}},{"kind":"Field","name":{"kind":"Name","value":"lessonScale"}},{"kind":"Field","name":{"kind":"Name","value":"translations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"locale"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"ancestors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"nodeType"}},{"kind":"Field","name":{"kind":"Name","value":"position"}},{"kind":"Field","name":{"kind":"Name","value":"translations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"locale"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetLessonsForRecordKeepingQuery, GetLessonsForRecordKeepingQueryVariables>;
export const MyLessonRecordStatsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MyLessonRecordStats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"myLessonRecordStats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"todayCount"}},{"kind":"Field","name":{"kind":"Name","value":"weekCount"}},{"kind":"Field","name":{"kind":"Name","value":"weekDelta"}},{"kind":"Field","name":{"kind":"Name","value":"studentsReached"}},{"kind":"Field","name":{"kind":"Name","value":"lessonsCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastRecordedAt"}}]}}]}}]} as unknown as DocumentNode<MyLessonRecordStatsQuery, MyLessonRecordStatsQueryVariables>;
...
export const RecentLessonRecordsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"RecentLessonRecords"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"locale"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"recentLessonRecords"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}},{"kind":"Argument","name":{"kind":"Name","value":"locale"},"value":{"kind":"Variable","name":{"kind":"Name","value":"locale"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lessonId"}},{"kind":"Field","name":{"kind":"Name","value":"lessonName"}},{"kind":"Field","name":{"kind":"Name","value":"areaName"}},{"kind":"Field","name":{"kind":"Name","value":"studentCount"}},{"kind":"Field","name":{"kind":"Name","value":"students"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"recordIds"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"durationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}}]}}]}}]} as unknown as DocumentNode<RecentLessonRecordsQuery, RecentLessonRecordsQueryVariables>;
...
export const UpdateLessonRecordsGroupDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateLessonRecordsGroup"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateLessonRecordsGroupInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateLessonRecordsGroup"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"studentId"}}]}}]}}]} as unknown as DocumentNode<UpdateLessonRecordsGroupMutation, UpdateLessonRecordsGroupMutationVariables>;
...
export const UpdateRoleMembersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateRoleMembers"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateRoleMembersInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateRoleMembers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<UpdateRoleMembersMutation, UpdateRoleMembersMutationVariables>;
...
export const GetSchoolYearDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetSchoolYear"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"date"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"schoolYear"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"date"},"value":{"kind":"Variable","name":{"kind":"Name","value":"date"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}},{"kind":"Field","name":{"kind":"Name","value":"startYear"}},{"kind":"Field","name":{"kind":"Name","value":"label"}}]}}]}}]} as unknown as DocumentNode<GetSchoolYearQuery, GetSchoolYearQueryVariables>;
...
export const GetOrganizationSetupStatusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetOrganizationSetupStatus"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"organizationSetupStatus"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"complete"}},{"kind":"Field","name":{"kind":"Name","value":"requiredRemaining"}},{"kind":"Field","name":{"kind":"Name","value":"steps"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"done"}},{"kind":"Field","name":{"kind":"Name","value":"required"}},{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}}]}}]} as unknown as DocumentNode<GetOrganizationSetupStatusQuery, GetOrganizationSetupStatusQueryVariables>;
...
export const EmployeeVacationSegmentsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EmployeeVacationSegments"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"employeeVacationSegments"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"employeeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"employeeVacationId"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"effectiveDays"}},{"kind":"Field","name":{"kind":"Name","value":"holidays"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"paidPercentage"}},{"kind":"Field","name":{"kind":"Name","value":"isWeekend"}}]}},{"kind":"Field","name":{"kind":"Name","value":"periodLabel"}},{"kind":"Field","name":{"kind":"Name","value":"periodStartDate"}},{"kind":"Field","name":{"kind":"Name","value":"periodEndDate"}},{"kind":"Field","name":{"kind":"Name","value":"isSplit"}}]}}]}}]} as unknown as DocumentNode<EmployeeVacationSegmentsQuery, EmployeeVacationSegmentsQueryVariables>;
export const CreateEmployeeVacationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateEmployeeVacation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateEmployeeVacationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createEmployeeVacation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"accrualType"}},{"kind":"Field","name":{"kind":"Name","value":"remark"}}]}}]}}]} as unknown as DocumentNode<CreateEmployeeVacationMutation, CreateEmployeeVacationMutationVariables>;
export const UpdateEmployeeVacationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateEmployeeVacation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateEmployeeVacationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateEmployeeVacation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<UpdateEmployeeVacationMutation, UpdateEmployeeVacationMutationVariables>;
export const DeleteEmployeeVacationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteEmployeeVacation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteEmployeeVacation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<DeleteEmployeeVacationMutation, DeleteEmployeeVacationMutationVariables>;
export const EmployeeMonthlyTimeTrackingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EmployeeMonthlyTimeTracking"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"from"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"to"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"locale"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"employeeMonthlyTimeTracking"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"employeeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"from"},"value":{"kind":"Variable","name":{"kind":"Name","value":"from"}}},{"kind":"Argument","name":{"kind":"Name","value":"to"},"value":{"kind":"Variable","name":{"kind":"Name","value":"to"}}},{"kind":"Argument","name":{"kind":"Name","value":"locale"},"value":{"kind":"Variable","name":{"kind":"Name","value":"locale"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"year"}},{"kind":"Field","name":{"kind":"Name","value":"month"}},{"kind":"Field","name":{"kind":"Name","value":"workedMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"plannedMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"days"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"workMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"plannedMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"entries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"breakMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"workMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"notes"}}]}}]}}]}}]}}]} as unknown as DocumentNode<EmployeeMonthlyTimeTrackingQuery, EmployeeMonthlyTimeTrackingQueryVariables>;
...
export const TimeTrackingPeriodAnchorDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"TimeTrackingPeriodAnchor"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"timeTrackingPeriodAnchor"}}]}}]} as unknown as DocumentNode<TimeTrackingPeriodAnchorQuery, TimeTrackingPeriodAnchorQueryVariables>;
export const SetTimeTrackingPeriodAnchorDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetTimeTrackingPeriodAnchor"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"anchor"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setTimeTrackingPeriodAnchor"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"anchor"},"value":{"kind":"Variable","name":{"kind":"Name","value":"anchor"}}}]}]}}]} as unknown as DocumentNode<SetTimeTrackingPeriodAnchorMutation, SetTimeTrackingPeriodAnchorMutationVariables>;
...
export const UpdateHolidayDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateHoliday"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateHolidayInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateHoliday"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<UpdateHolidayMutation, UpdateHolidayMutationVariables>;
...
export const UpdateCompanyVacationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateCompanyVacation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateCompanyVacationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateCompanyVacation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<UpdateCompanyVacationMutation, UpdateCompanyVacationMutationVariables>;
...
export const TeamShiftsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"TeamShifts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"teamId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"teamShifts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"teamId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"teamId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"startTime"}},{"kind":"Field","name":{"kind":"Name","value":"endTime"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"sortOrder"}},{"kind":"Field","name":{"kind":"Name","value":"breaks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"startTime"}},{"kind":"Field","name":{"kind":"Name","value":"endTime"}}]}},{"kind":"Field","name":{"kind":"Name","value":"teamIds"}}]}}]}}]} as unknown as DocumentNode<TeamShiftsQuery, TeamShiftsQueryVariables>;
...
export const UpdateShiftDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateShift"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateShiftInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateShift"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"startTime"}},{"kind":"Field","name":{"kind":"Name","value":"endTime"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"sortOrder"}},{"kind":"Field","name":{"kind":"Name","value":"breaks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"startTime"}},{"kind":"Field","name":{"kind":"Name","value":"endTime"}}]}},{"kind":"Field","name":{"kind":"Name","value":"teamIds"}}]}}]}}]} as unknown as DocumentNode<UpdateShiftMutation, UpdateShiftMutationVariables>;
export const DeleteShiftDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteShift"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteShift"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<DeleteShiftMutation, DeleteShiftMutationVariables>;
export const SetTeamShiftsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetTeamShifts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SetTeamShiftsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setTeamShifts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"startTime"}},{"kind":"Field","name":{"kind":"Name","value":"endTime"}},{"kind":"Field","name":{"kind":"Name","value":"color"}},{"kind":"Field","name":{"kind":"Name","value":"sortOrder"}},{"kind":"Field","name":{"kind":"Name","value":"breaks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"startTime"}},{"kind":"Field","name":{"kind":"Name","value":"endTime"}}]}},{"kind":"Field","name":{"kind":"Name","value":"teamIds"}}]}}]}}]} as unknown as DocumentNode<SetTeamShiftsMutation, SetTeamShiftsMutationVariables>;
