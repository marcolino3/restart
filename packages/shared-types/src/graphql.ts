...
export type RecentLessonRecordsQuery = { __typename?: 'Query', recentLessonRecords: Array<{ __typename?: 'RecentLessonRecordOutput', lessonId: string, lessonName?: string | null, areaName?: string | null, studentCount: number, recordedAt: string }> };
