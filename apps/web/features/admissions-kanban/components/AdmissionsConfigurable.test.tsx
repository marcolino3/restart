...
const application = (
  ...
  assignedGradeLevelId: "g1",
  assignedGradeLevelName: "Stufe 1",
  assignedGradeLevelColor: "#fff",
  assignedStufe: { id: "g1", name: "Stufe 1", shortCode: "US", color: "#fff" },
  assignedUntergruppe: null,
