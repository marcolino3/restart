...
import { TiptapSkeleton } from '../common/skeletons.tsx/tiptap-skeleton';
...
export const FormEditorWithActions = ({
  name,
  label,
  index,
  rawLabel = false,
  ...
  // Extract the field key from name (e.g., "translations.0.text" -> "text")
  const getFieldKey = () => {
