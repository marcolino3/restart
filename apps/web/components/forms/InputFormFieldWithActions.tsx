...
import { InputSkeleton } from '../common/skeletons.tsx/input-skeleton';
...
export const InputFormFieldWithActions = ({
  name,
  label,
  index,
  rawLabel = false,
  ...
  // Extract the field key from name (e.g., "translations.0.title" -> "title")
  const getFieldKey = () => {
