  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-[13.5px] font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gold text-gold-foreground font-bold shadow-xs hover:bg-gold/90",
      },
      size: {
        default: "h-[38px] px-[17px] py-2 has-[>svg]:px-3.5",
        sm: "h-8 gap-1.5 px-3.5 text-xs has-[>svg]:px-3",
        lg: "h-12 text-base font-semibold px-6 has-[>svg]:px-5",
        icon: "size-[38px]",
      },
    },
    defaultVariants: {
